...
return '• اصدار سورس Kat : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس Kat يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
سورس Kat
 ...
 [Armando](t.me/IIIZIIII)

 [ - سـورس kat  ](t.me/lliii0)
...
elseif Text== "ارماندو" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس Kat↯](https://t.me/IIIZIIII)")
...
‏
  ...
  --=====================================
  elseif Text== "ارماندو" or Text== "اباظه" or Text=="حيدر" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"مطور السورس ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"مطور السورس منشئي")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"مطور سورسي يا مدير")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,مطور السورس يا ادمن")
else 
return sendMsg(msg.chat_id_,msg.id_,"مطور سورس kat يا عضو")
end 
end 
